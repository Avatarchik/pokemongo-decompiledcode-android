...
public class Assert
{
  ...
  public static void AreEqual(byte paramByte1, byte paramByte2)
  {
    if ((IsEnabled) && (paramByte1 != paramByte2))
    {
      ...
      arrayOfObject[0] = toString(Byte.valueOf(paramByte1));
      arrayOfObject[1] = toString(Byte.valueOf(paramByte2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(byte paramByte1, byte paramByte2, String paramString, Object paramObject)
  {
    if ((IsEnabled) && (paramByte1 != paramByte2))
    {
      ...
      AssertHelper(paramString, arrayOfObject);
    }
  }
  ...
  public static void AreEqual(char paramChar1, char paramChar2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(Character.valueOf(paramChar1));
      arrayOfObject[1] = toString(Character.valueOf(paramChar2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(double paramDouble1, double paramDouble2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(Double.valueOf(paramDouble1));
      arrayOfObject[1] = toString(Double.valueOf(paramDouble2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(float paramFloat1, float paramFloat2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(Float.valueOf(paramFloat1));
      arrayOfObject[1] = toString(Float.valueOf(paramFloat2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(int paramInt1, int paramInt2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(Integer.valueOf(paramInt1));
      arrayOfObject[1] = toString(Integer.valueOf(paramInt2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(long paramLong1, long paramLong2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(Long.valueOf(paramLong1));
      arrayOfObject[1] = toString(Long.valueOf(paramLong2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(Object paramObject1, Object paramObject2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(paramObject1);
      arrayOfObject[1] = toString(paramObject2);
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(short paramShort1, short paramShort2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = toString(Short.valueOf(paramShort1));
      arrayOfObject[1] = toString(Short.valueOf(paramShort2));
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreEqual(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = Boolean.toString(paramBoolean1);
      arrayOfObject[1] = Boolean.toString(paramBoolean2);
      AssertHelper("Assertion failed: expected '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreNotEqual(byte paramByte1, byte paramByte2)
  {
    if ((IsEnabled) && (paramByte1 == paramByte2))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = toString(Byte.valueOf(paramByte1));
      AssertHelper("Assertion failed: values are equal '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreNotEqual(Object paramObject1, Object paramObject2)
  {
    if ((IsEnabled) && (((paramObject1 != null) && (paramObject2 != null) && (paramObject1.equals(paramObject2))) || ((paramObject1 == null) && (paramObject2 == null))))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = toString(paramObject1);
      AssertHelper("Assertion failed: Objects are equal '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreNotEqual(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = toString(Boolean.valueOf(paramBoolean1));
      AssertHelper("Assertion failed: values are equal '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreNotSame(Object paramObject1, Object paramObject2)
  {
    if ((IsEnabled) && (paramObject1 == paramObject2))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = toString(paramObject1);
      AssertHelper("Assertion failed: Object references are the same '%s'", arrayOfObject);
    }
  }
  ...
  public static void AreSame(Object paramObject1, Object paramObject2)
  {
    if ((IsEnabled) && (paramObject1 != paramObject2))
    {
      ...
      arrayOfObject[0] = toString(paramObject1);
      arrayOfObject[1] = toString(paramObject2);
      AssertHelper("Assertion failed: Object references are not the same '%s' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static <T> void Contains(T paramT, Collection<T> paramCollection)
  {
    ...
    for (;;)
    {
      ...
      AssertHelper("Assertion failed: collection doesn't contain the item %s", arrayOfObject);
    }
  }
  ...
  public static void Greater(byte paramByte1, byte paramByte2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = Byte.valueOf(paramByte1);
      arrayOfObject[1] = Byte.valueOf(paramByte2);
      AssertHelper("Assertion failed: '%s' > '%s'", arrayOfObject);
    }
  }
  ...
  public static void Greater(char paramChar1, char paramChar2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = Character.valueOf(paramChar1);
      arrayOfObject[1] = Character.valueOf(paramChar2);
      AssertHelper("Assertion failed: '%s' > '%s'", arrayOfObject);
    }
  }
  ...
  public static void Greater(short paramShort1, short paramShort2)
  {
    ...
    {
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = Short.valueOf(paramShort1);
      arrayOfObject[1] = Short.valueOf(paramShort2);
      AssertHelper("Assertion failed: '%s' > '%s'", arrayOfObject);
    }
  }
  ...
  public static void IsEmpty(String paramString)
  {
    if ((IsEnabled) && (!StringUtils.IsNullOrEmpty(paramString)))
    {
      ...
      AssertHelper("Assertion failed: String is not empty '%s'", arrayOfObject);
    }
  }
  ...
  public static void IsEmpty(String paramString1, String paramString2, Object paramObject)
  {
    if ((IsEnabled) && (!StringUtils.IsNullOrEmpty(paramString1)))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = paramObject;
      AssertHelper(paramString2, arrayOfObject);
    }
  }
  ...
  public static void IsEmpty(Collection<?> paramCollection)
  {
    ...
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = paramCollection;
      AssertHelper("Assertion failed: collection is null or not empty '%s'", arrayOfObject);
    }
  }
  ...
  public static void IsInstanceOfType(Class<?> paramClass, Object paramObject)
  {
    ...
    for (Class localClass = paramObject.getClass();; localClass = null)
    {
      ...
      AssertHelper("Assertion failed: expected type of '%s' but was '%s'", arrayOfObject);
      return;
    }
  }
  ...
  public static void IsNotEmpty(String paramString)
  {
    if ((IsEnabled) && (StringUtils.IsNullOrEmpty(paramString)))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = paramString;
      AssertHelper("Assertion failed: String is null or empty '%s'", arrayOfObject);
    }
  }
  ...
  public static void IsNotEmpty(Collection<?> paramCollection)
  {
    if ((IsEnabled) && (paramCollection != null) && (paramCollection.size() != 0))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = paramCollection;
      AssertHelper("Assertion failed: collection is null or empty '%s'", arrayOfObject);
    }
  }
  ...
  public static void IsNotInstanceOfType(Class<?> paramClass, Object paramObject)
  {
    ...
    {
      arrayOfObject[1] = localClass;
      AssertHelper("Assertion failed: Object '%s' is subtype of '%s'", arrayOfObject);
      return;
    }
  }
  ...
  public static void IsNotNullElement(List<?> paramList)
  {
    if (IsEnabled)
    {
      ...
      {
        IsNotNull(localIterator.next(), "Element at %s is null", toString(Integer.valueOf(i)));
        i++;
      }
    }
  }
  ...
  public static void IsNull(Object paramObject)
  {
    if ((IsEnabled) && (paramObject != null))
    {
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = paramObject;
      AssertHelper("Assertion failed: expected 'null' but was '%s'", arrayOfObject);
    }
  }
  ...
  public static <T> void NotContains(T paramT, Collection<T> paramCollection)
  {
    ...
    for (;;)
    {
      ...
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = paramT;
      AssertHelper("Assertion failed: collection contains the item %s", arrayOfObject);
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/spacemadness/com/lunarconsole/debug/Assert.class
