  ...
  implements Destroyable, ConsoleAdapter.DataSource
{
  ...
  void logMessage(ConsoleEntry paramConsoleEntry)
  {
    ...
    int j = this.entries.trimmedCount() - i;
    if (j > 0) {
      notifyRemoveEntries(0, j);
    }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/spacemadness/com/lunarconsole/console/Console.class
