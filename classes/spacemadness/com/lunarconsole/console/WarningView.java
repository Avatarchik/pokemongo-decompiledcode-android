  ...
  implements Destroyable
{
  ...
  {
    View localView = LayoutInflater.from(paramContext).inflate(R.layout.lunar_layout_warning, null, false);
    setupUI(localView);
    addView(localView, new FrameLayout.LayoutParams(-1, -2, 81));
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/spacemadness/com/lunarconsole/console/WarningView.class
