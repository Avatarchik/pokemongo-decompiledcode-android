...
public class ViewPropertyAnimatorCompat
{
  ...
  public long getDuration()
  {
    View localView = (View)this.mView.get();
    if (localView != null) {}
    for (long l = IMPL.getDuration(this, localView);; l = 0L) {
      return l;
    }
  }
  ...
  public Interpolator getInterpolator()
  {
    View localView = (View)this.mView.get();
    if (localView != null) {}
    for (Interpolator localInterpolator = IMPL.getInterpolator(this, localView);; localInterpolator = null) {
  ...
  public long getStartDelay()
  {
    View localView = (View)this.mView.get();
    if (localView != null) {}
    for (long l = IMPL.getStartDelay(this, localView);; l = 0L) {
      return l;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/view/ViewPropertyAnimatorCompat.class
