...
public class ViewCompat
{
    ...
    extends ViewCompat.HCViewCompatImpl
  {
    ...
    public boolean hasAccessibilityDelegate(View paramView)
    {
      ...
      //   2: iconst_0
      //   3: istore_3
      //   4: getstatic 15	android/support/v4/view/ViewCompat$ICSViewCompatImpl:accessibilityDelegateCheckFailed	Z
      //   7: ifeq +5 -> 12
      //   10: iload_3
      //   11: ireturn
      //   12: getstatic 55	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   15: ifnonnull +20 -> 35
      //   18: ldc 57
      //   20: ldc 59
      //   22: invokevirtual 65	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
      //   25: putstatic 55	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   28: getstatic 55	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   31: iconst_1
      //   32: invokevirtual 71	java/lang/reflect/Field:setAccessible	(Z)V
      //   35: getstatic 55	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   38: aload_1
      //   39: invokevirtual 72	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
      //   42: astore 5
      //   44: aload 5
      //   46: ifnull +17 -> 63
      //   49: iload_2
      ...
      //   54: astore 6
      //   56: iload_2
      //   57: putstatic 15	android/support/v4/view/ViewCompat$ICSViewCompatImpl:accessibilityDelegateCheckFailed	Z
      //   60: goto -50 -> 10
      //   63: iconst_0
      //   64: istore_2
      //   65: goto -16 -> 49
      //   68: astore 4
      //   70: iload_2
      //   71: putstatic 15	android/support/v4/view/ViewCompat$ICSViewCompatImpl:accessibilityDelegateCheckFailed	Z
      //   74: goto -64 -> 10
      ...
      //   68	1	4	localThrowable1	Throwable
      //   42	3	5	localObject	Object
      //   54	1	6	localThrowable2	Throwable
      // Exception table:
      //   from	to	target	type
    ...
    implements ViewCompat.ViewCompatImpl
  {
    ...
    public boolean canScrollHorizontally(View paramView, int paramInt)
    {
      if (((paramView instanceof ScrollingView)) && (canScrollingViewScrollHorizontally((ScrollingView)paramView, paramInt))) {}
    ...
    public boolean canScrollVertically(View paramView, int paramInt)
    {
      if (((paramView instanceof ScrollingView)) && (canScrollingViewScrollVertically((ScrollingView)paramView, paramInt))) {}
      for (boolean bool = true;; bool = false) {
        return bool;
      }
    }
    ...
    public boolean dispatchNestedFling(View paramView, float paramFloat1, float paramFloat2, boolean paramBoolean)
    {
      ...
      for (boolean bool = ((NestedScrollingChild)paramView).dispatchNestedFling(paramFloat1, paramFloat2, paramBoolean);; bool = false) {
        return bool;
      }
    }
    ...
    {
      if ((paramView instanceof NestedScrollingChild)) {}
      for (boolean bool = ((NestedScrollingChild)paramView).dispatchNestedPreFling(paramFloat1, paramFloat2);; bool = false) {
        return bool;
      }
    }
    ...
    {
      if ((paramView instanceof NestedScrollingChild)) {}
      for (boolean bool = ((NestedScrollingChild)paramView).dispatchNestedPreScroll(paramInt1, paramInt2, paramArrayOfInt1, paramArrayOfInt2);; bool = false) {
        return bool;
      }
    }
    ...
    {
      if ((paramView instanceof NestedScrollingChild)) {}
      for (boolean bool = ((NestedScrollingChild)paramView).dispatchNestedScroll(paramInt1, paramInt2, paramInt3, paramInt4, paramArrayOfInt);; bool = false) {
        return bool;
      }
    }
    ...
    {
      if ((paramView instanceof NestedScrollingChild)) {}
      for (boolean bool = ((NestedScrollingChild)paramView).hasNestedScrollingParent();; bool = false) {
        return bool;
      }
    }
    ...
    {
      if ((paramView instanceof NestedScrollingChild)) {}
      for (boolean bool = ((NestedScrollingChild)paramView).isNestedScrollingEnabled();; bool = false) {
        return bool;
      }
    }
    ...
    {
      if ((paramView instanceof NestedScrollingChild)) {}
      for (boolean bool = ((NestedScrollingChild)paramView).startNestedScroll(paramInt);; bool = false) {
        return bool;
      }
    }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/view/ViewCompat.class
