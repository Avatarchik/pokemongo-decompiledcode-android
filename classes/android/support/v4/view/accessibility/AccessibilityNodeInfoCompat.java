...
public class AccessibilityNodeInfoCompat
{
  ...
  public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByViewId(String paramString)
  {
    ...
    if (localList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((List)localObject).add(new AccessibilityNodeInfoCompat(localIterator.next()));
      }
    }
  ...
  {
    CollectionInfoCompat localCollectionInfoCompat = null;
    Object localObject = IMPL.getCollectionInfo(this.mInfo);
    if (localObject == null) {}
    for (;;)
    {
      return localCollectionInfoCompat;
      localCollectionInfoCompat = new CollectionInfoCompat(localObject, null);
    }
  }
  
  public CollectionItemInfoCompat getCollectionItemInfo()
  {
    CollectionItemInfoCompat localCollectionItemInfoCompat = null;
    Object localObject = IMPL.getCollectionItemInfo(this.mInfo);
    if (localObject == null) {}
    for (;;)
    {
      return localCollectionItemInfoCompat;
      localCollectionItemInfoCompat = new CollectionItemInfoCompat(localObject, null);
    }
  }
  ...
  {
    RangeInfoCompat localRangeInfoCompat = null;
    Object localObject = IMPL.getRangeInfo(this.mInfo);
    if (localObject == null) {}
    for (;;)
    {
      return localRangeInfoCompat;
      localRangeInfoCompat = new RangeInfoCompat(localObject, null);
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/view/accessibility/AccessibilityNodeInfoCompat.class
