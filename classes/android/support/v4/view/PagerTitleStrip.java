  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i2 = m - i1;
    int i3 = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int)(0.8F * k)), Integer.MIN_VALUE);
    int i4 = View.MeasureSpec.makeMeasureSpec(Math.min(0, i2), Integer.MIN_VALUE);
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter)
  {
    ...
    for (CharSequence localCharSequence2 = paramPagerAdapter.getPageTitle(paramInt);; localCharSequence2 = null)
    {
      ...
      int j = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int)(0.8F * (getWidth() - getPaddingLeft() - getPaddingRight()))), Integer.MIN_VALUE);
      int k = View.MeasureSpec.makeMeasureSpec(Math.max(0, getHeight() - getPaddingTop() - getPaddingBottom()), Integer.MIN_VALUE);
      this.mPrevText.measure(j, k);
      this.mCurrText.measure(j, k);
      this.mNextText.measure(j, k);
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/view/PagerTitleStrip.class
