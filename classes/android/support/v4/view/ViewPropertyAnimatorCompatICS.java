  ...
  public static void setListener(final View paramView, ViewPropertyAnimatorListener paramViewPropertyAnimatorListener)
  {
    if (paramViewPropertyAnimatorListener != null) {
      paramView.animate().setListener(new AnimatorListenerAdapter()
      {
        ...
        {
          ViewPropertyAnimatorCompatICS.this.onAnimationCancel(paramView);
        }
        
        public void onAnimationEnd(Animator paramAnonymousAnimator)
        {
          ViewPropertyAnimatorCompatICS.this.onAnimationEnd(paramView);
        }
        
        public void onAnimationStart(Animator paramAnonymousAnimator)
        {
          ViewPropertyAnimatorCompatICS.this.onAnimationStart(paramView);
        }
      });
    }
    for (;;)
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/view/ViewPropertyAnimatorCompatICS.class
