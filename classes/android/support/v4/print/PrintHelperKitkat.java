...
class PrintHelperKitkat
{
    ...
    throws FileNotFoundException
  {
    ...
    //   8: ifnonnull +13 -> 21
    //   11: new 158	java/lang/IllegalArgumentException
    //   14: dup
    //   15: ldc -96
    //   17: invokespecial 163	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   20: athrow
    //   21: aconst_null
    //   22: astore_3
    //   23: aload_0
    //   24: getfield 52	android/support/v4/print/PrintHelperKitkat:mContext	Landroid/content/Context;
    //   27: invokevirtual 169	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   30: aload_1
    //   31: invokevirtual 175	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   34: astore_3
    //   35: aload_3
    //   36: aconst_null
    //   37: aload_2
    //   38: invokestatic 181	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   41: astore 7
    //   43: aload_3
    //   44: ifnull +7 -> 51
    //   47: aload_3
    //   48: invokevirtual 186	java/io/InputStream:close	()V
    //   51: aload 7
    //   53: areturn
    //   54: astore 8
    //   56: ldc 20
    //   58: ldc -68
    //   60: aload 8
    //   62: invokestatic 194	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   65: pop
    //   66: goto -15 -> 51
    //   69: astore 4
    //   71: aload_3
    //   72: ifnull +7 -> 79
    //   75: aload_3
    //   76: invokevirtual 186	java/io/InputStream:close	()V
    //   79: aload 4
    //   81: athrow
    //   82: astore 5
    //   84: ldc 20
    //   86: ldc -68
    //   88: aload 5
    //   90: invokestatic 194	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   93: pop
    //   94: goto -15 -> 79
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	97	0	this	PrintHelperKitkat
    //   0	97	1	paramUri	Uri
    //   0	97	2	paramOptions	BitmapFactory.Options
    //   22	54	3	localInputStream	java.io.InputStream
    //   69	11	4	localObject	Object
    //   82	7	5	localIOException1	java.io.IOException
    //   41	11	7	localBitmap	Bitmap
    //   54	7	8	localIOException2	java.io.IOException
    // Exception table:
    //   from	to	target	type
    ...
    for (;;)
    {
      ...
      localPrintManager.print(paramString, new PrintDocumentAdapter()
      {
        ...
        public void onWrite(android.print.PageRange[] paramAnonymousArrayOfPageRange, android.os.ParcelFileDescriptor paramAnonymousParcelFileDescriptor, CancellationSignal paramAnonymousCancellationSignal, android.print.PrintDocumentAdapter.WriteResultCallback paramAnonymousWriteResultCallback)
        {
          ...
          //   242	1	8	localIOException1	java.io.IOException
          //   46	60	9	localPage	android.graphics.pdf.PdfDocument.Page
          //   63	17	10	localRectF	RectF
          //   88	10	11	localMatrix	Matrix
          //   179	7	12	localIOException2	java.io.IOException
          //   237	1	14	localIOException3	java.io.IOException
    ...
    throws FileNotFoundException
  {
    PrintDocumentAdapter local2 = new PrintDocumentAdapter()
    {
      ...
      public void onWrite(android.print.PageRange[] paramAnonymousArrayOfPageRange, android.os.ParcelFileDescriptor paramAnonymousParcelFileDescriptor, CancellationSignal paramAnonymousCancellationSignal, android.print.PrintDocumentAdapter.WriteResultCallback paramAnonymousWriteResultCallback)
      {
        ...
        //   11: aload_0
        //   12: getfield 86	android/support/v4/print/PrintHelperKitkat$2:mAttributes	Landroid/print/PrintAttributes;
        //   15: invokespecial 145	android/print/pdf/PrintedPdfDocument:<init>	(Landroid/content/Context;Landroid/print/PrintAttributes;)V
        //   18: astore 5
        //   20: aload_0
        //   21: getfield 32	android/support/v4/print/PrintHelperKitkat$2:this$0	Landroid/support/v4/print/PrintHelperKitkat;
        //   24: aload_0
        //   25: getfield 45	android/support/v4/print/PrintHelperKitkat$2:mBitmap	Landroid/graphics/Bitmap;
        //   28: aload_0
        //   29: getfield 86	android/support/v4/print/PrintHelperKitkat$2:mAttributes	Landroid/print/PrintAttributes;
        ...
        //   63: astore 10
        //   65: aload_0
        //   66: getfield 32	android/support/v4/print/PrintHelperKitkat$2:this$0	Landroid/support/v4/print/PrintHelperKitkat;
        //   69: aload_0
        //   70: getfield 45	android/support/v4/print/PrintHelperKitkat$2:mBitmap	Landroid/graphics/Bitmap;
        //   73: invokevirtual 177	android/graphics/Bitmap:getWidth	()I
        //   76: aload_0
        //   77: getfield 45	android/support/v4/print/PrintHelperKitkat$2:mBitmap	Landroid/graphics/Bitmap;
        //   80: invokevirtual 180	android/graphics/Bitmap:getHeight	()I
        //   83: aload 10
        //   85: aload_0
        //   86: getfield 40	android/support/v4/print/PrintHelperKitkat$2:val$fittingMode	I
        ...
        //   168: aload 6
        //   170: aload_0
        //   171: getfield 45	android/support/v4/print/PrintHelperKitkat$2:mBitmap	Landroid/graphics/Bitmap;
        //   174: if_acmpeq +8 -> 182
        //   177: aload 6
        //   179: invokevirtual 82	android/graphics/Bitmap:recycle	()V
        //   182: return
        //   183: astore 12
        //   185: ldc -25
        //   187: ldc -23
        ...
        //   224: aload 6
        //   226: aload_0
        //   227: getfield 45	android/support/v4/print/PrintHelperKitkat$2:mBitmap	Landroid/graphics/Bitmap;
        //   230: if_acmpeq +8 -> 238
        //   233: aload 6
        //   235: invokevirtual 82	android/graphics/Bitmap:recycle	()V
        //   238: aload 7
        //   240: athrow
        //   241: astore 14
        //   243: goto -75 -> 168
        ...
        //   246	1	8	localIOException1	java.io.IOException
        //   46	64	9	localPage	android.graphics.pdf.PdfDocument.Page
        //   63	21	10	localRectF	RectF
        //   92	10	11	localMatrix	Matrix
        //   183	7	12	localIOException2	java.io.IOException
        //   241	1	14	localIOException3	java.io.IOException
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/print/PrintHelperKitkat.class
