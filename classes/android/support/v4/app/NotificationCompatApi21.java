  ...
  static NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(Bundle paramBundle, NotificationCompatBase.UnreadConversation.Factory paramFactory, RemoteInputCompatBase.RemoteInput.Factory paramFactory1)
  {
    ...
    for (int j = 0;; j++)
    {
      ...
      for (i = 0;; i = 0)
      {
        ...
        localObject1 = paramFactory.build((String[])localObject2, (RemoteInputCompatBase.RemoteInput)localObject1, localPendingIntent2, localPendingIntent1, arrayOfString1, paramBundle.getLong("timestamp"));
        break;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/app/NotificationCompatApi21.class
