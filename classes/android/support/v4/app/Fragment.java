  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  {
    if (this.mHost == null) {}
    for (FragmentActivity localFragmentActivity = null;; localFragmentActivity = (FragmentActivity)this.mHost.getActivity()) {
  ...
  public boolean getAllowEnterTransitionOverlap()
  {
    ...
    for (boolean bool = true;; bool = this.mAllowEnterTransitionOverlap.booleanValue()) {
      return bool;
    }
  }
  ...
  public boolean getAllowReturnTransitionOverlap()
  {
    ...
    for (boolean bool = true;; bool = this.mAllowReturnTransitionOverlap.booleanValue()) {
      return bool;
    }
  }
  ...
  {
    if (this.mHost == null) {}
    for (Context localContext = null;; localContext = this.mHost.getContext()) {
      return localContext;
    }
  }
  ...
  public Object getReenterTransition()
  {
    ...
    for (Object localObject = getExitTransition();; localObject = this.mReenterTransition) {
      return localObject;
    }
  }
  ...
  public Object getReturnTransition()
  {
    ...
    for (Object localObject = getEnterTransition();; localObject = this.mReturnTransition) {
      return localObject;
    }
  }
  ...
  public Object getSharedElementReturnTransition()
  {
    ...
    for (Object localObject = getSharedElementEnterTransition();; localObject = this.mSharedElementReturnTransition) {
      return localObject;
    }
  }
  ...
  {
    if (this.mHost != null) {}
    for (boolean bool = this.mHost.onShouldShowRequestPermissionRationale(paramString);; bool = false) {
      return bool;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/app/Fragment.class
