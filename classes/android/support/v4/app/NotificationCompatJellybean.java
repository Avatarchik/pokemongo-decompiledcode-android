...
class NotificationCompatJellybean
{
  ...
  {
    NotificationCompatBase.Action localAction1;
    synchronized (sActionsLock)
    {
      try
      {
        ...
        Bundle localBundle2 = getExtras(paramNotification);
        if (localBundle2 != null)
        {
          SparseArray localSparseArray = localBundle2.getSparseParcelableArray("android.support.actionExtras");
          if (localSparseArray != null) {
            localBundle1 = (Bundle)localSparseArray.get(paramInt);
          }
        }
        NotificationCompatBase.Action localAction2 = readAction(paramFactory, paramFactory1, sActionIconField.getInt(localObject3), (CharSequence)sActionTitleField.get(localObject3), (PendingIntent)sActionIntentField.get(localObject3), localBundle1);
        localAction1 = localAction2;
      }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/app/NotificationCompatJellybean.class
