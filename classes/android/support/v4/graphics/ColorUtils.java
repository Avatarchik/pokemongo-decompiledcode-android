...
public class ColorUtils
{
  ...
  {
    if (paramInt5 == 0) {}
    for (int i = 0;; i = (paramInt2 * (paramInt1 * 255) + paramInt3 * paramInt4 * (255 - paramInt2)) / (paramInt5 * 255)) {
      return i;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/graphics/ColorUtils.class
