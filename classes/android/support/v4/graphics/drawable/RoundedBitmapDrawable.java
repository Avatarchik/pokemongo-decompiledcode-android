  ...
  extends Drawable
{
  ...
  RoundedBitmapDrawable(Resources paramResources, Bitmap paramBitmap)
  {
    ...
    for (this.mBitmapShader = new BitmapShader(this.mBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);; this.mBitmapShader = null)
    {
      return;
  ...
  public int getOpacity()
  {
    ...
    for (;;)
    {
      return i;
      Bitmap localBitmap = this.mBitmap;
      if ((localBitmap != null) && (!localBitmap.hasAlpha()) && (this.mPaint.getAlpha() >= 255) && (!isGreaterThanZero(this.mCornerRadius))) {
        i = -1;
      }
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/graphics/drawable/RoundedBitmapDrawable.class
