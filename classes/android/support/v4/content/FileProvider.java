  ...
  extends ContentProvider
{
  ...
  private static PathStrategy getPathStrategy(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      return (PathStrategy)localObject2;
    }
    ...
    public Uri getUriForFile(File paramFile)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((str1.startsWith(str5)) && ((localObject == null) || (str5.length() > ((File)((Map.Entry)localObject).getValue()).getPath().length()))) {
      ...
      {
        String str4 = Uri.encode((String)((Map.Entry)localObject).getKey()) + '/' + Uri.encode(str3, "/");
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/content/FileProvider.class
