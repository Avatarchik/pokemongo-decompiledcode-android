  ...
  extends ViewGroup
{
  ...
  private void onPanelDragged(int paramInt)
  {
    ...
    label147:
    label156:
    for (int m = localLayoutParams.rightMargin;; m = localLayoutParams.leftMargin)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
        ...
        for (;;)
        {
          ...
          if (localView1.getVisibility() != 8)
          {
            ...
            if ((localLayoutParams1.width == 0) && (localLayoutParams1.weight > 0.0F))
            {
              ...
              i14 = View.MeasureSpec.makeMeasureSpec(i1, Integer.MIN_VALUE);
            }
            for (;;)
            {
            ...
            if (localLayoutParams1.weight > 0.0F)
            {
              ...
              if (localLayoutParams1.width == 0) {
                if (localLayoutParams1.height == -2) {
                  i10 = View.MeasureSpec.makeMeasureSpec(i1, Integer.MIN_VALUE);
                }
              }
              for (;;)
              {
    ...
    setMeasuredDimension(j, n + getPaddingTop() + getPaddingBottom());
    ...
    extends ViewDragHelper.Callback
  {
    ...
    public int clampViewPositionHorizontal(View paramView, int paramInt1, int paramInt2)
    {
      ...
      {
        m = SlidingPaneLayout.this.getWidth() - (SlidingPaneLayout.this.getPaddingRight() + localLayoutParams.rightMargin + SlidingPaneLayout.this.mSlideableView.getWidth());
        n = m - SlidingPaneLayout.this.mSlideRange;
      }
      int i;
      int j;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/widget/SlidingPaneLayout.class
