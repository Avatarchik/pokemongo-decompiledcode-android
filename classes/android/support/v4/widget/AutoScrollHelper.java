  ...
  implements View.OnTouchListener
{
  ...
  public AutoScrollHelper(View paramView)
  {
    ...
    arrayOfFloat2[0] = Float.MAX_VALUE;
    arrayOfFloat2[1] = Float.MAX_VALUE;
  ...
  private static class ClampedScroller
  {
    ...
    private float getValueAt(long paramLong)
    {
      ...
      for (;;)
      {
        ...
        {
          f = 0.5F * AutoScrollHelper.constrain((float)(paramLong - this.mStartTime) / this.mRampUpDuration, 0.0F, 1.0F);
        }
        else
        {
          long l = paramLong - this.mStopTime;
          f = 1.0F - this.mStopValue + this.mStopValue * AutoScrollHelper.constrain((float)l / this.mEffectiveRampDown, 0.0F, 1.0F);
        }
      }
    }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/widget/AutoScrollHelper.class
