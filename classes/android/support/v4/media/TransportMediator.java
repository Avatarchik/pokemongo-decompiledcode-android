  ...
  extends TransportController
{
  ...
  final KeyEvent.Callback mKeyEventCallback = new KeyEvent.Callback()
  {
    public boolean onKeyDown(int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
    {
      ...
      for (boolean bool = TransportMediator.this.mCallbacks.onMediaButtonDown(paramAnonymousInt, paramAnonymousKeyEvent);; bool = false) {
        return bool;
      }
    }
    ...
    {
      if (TransportMediator.isMediaKey(paramAnonymousInt)) {}
      for (boolean bool = TransportMediator.this.mCallbacks.onMediaButtonUp(paramAnonymousInt, paramAnonymousKeyEvent);; bool = false) {
        return bool;
      }
    }
  };
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/TransportMediator.class
