  ...
  implements Parcelable
{
  public static final Parcelable.Creator<MediaDescriptionCompat> CREATOR = new Parcelable.Creator()
  {
    public MediaDescriptionCompat createFromParcel(Parcel paramAnonymousParcel)
    {
      ...
      for (MediaDescriptionCompat localMediaDescriptionCompat = new MediaDescriptionCompat(paramAnonymousParcel, null);; localMediaDescriptionCompat = MediaDescriptionCompat.fromMediaDescription(MediaDescriptionCompatApi21.fromParcel(paramAnonymousParcel))) {
  ...
  public Object getMediaDescription()
  {
    ...
    for (Object localObject1 = this.mDescriptionObj;; localObject1 = this.mDescriptionObj)
    {
      return localObject1;
      Object localObject2 = MediaDescriptionCompatApi21.Builder.newInstance();
      MediaDescriptionCompatApi21.Builder.setMediaId(localObject2, this.mMediaId);
      MediaDescriptionCompatApi21.Builder.setTitle(localObject2, this.mTitle);
      MediaDescriptionCompatApi21.Builder.setSubtitle(localObject2, this.mSubtitle);
      MediaDescriptionCompatApi21.Builder.setDescription(localObject2, this.mDescription);
      MediaDescriptionCompatApi21.Builder.setIconBitmap(localObject2, this.mIcon);
      MediaDescriptionCompatApi21.Builder.setIconUri(localObject2, this.mIconUri);
      MediaDescriptionCompatApi21.Builder.setExtras(localObject2, this.mExtras);
      if (Build.VERSION.SDK_INT >= 23) {
        MediaDescriptionCompatApi23.Builder.setMediaUri(localObject2, this.mMediaUri);
      }
      this.mDescriptionObj = MediaDescriptionCompatApi21.Builder.build(localObject2);
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/MediaDescriptionCompat.class
