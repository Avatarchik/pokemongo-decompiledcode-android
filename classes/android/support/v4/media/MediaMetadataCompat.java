  ...
  implements Parcelable
{
  ...
  static
  {
    ...
    arrayOfString1[0] = "android.media.metadata.TITLE";
    arrayOfString1[1] = "android.media.metadata.ARTIST";
    arrayOfString1[2] = "android.media.metadata.ALBUM";
    arrayOfString1[3] = "android.media.metadata.ALBUM_ARTIST";
    arrayOfString1[4] = "android.media.metadata.WRITER";
    arrayOfString1[5] = "android.media.metadata.AUTHOR";
    arrayOfString1[6] = "android.media.metadata.COMPOSER";
    PREFERRED_DESCRIPTION_ORDER = arrayOfString1;
    String[] arrayOfString2 = new String[3];
    arrayOfString2[0] = "android.media.metadata.DISPLAY_ICON";
    arrayOfString2[1] = "android.media.metadata.ART";
    arrayOfString2[2] = "android.media.metadata.ALBUM_ART";
    PREFERRED_BITMAP_ORDER = arrayOfString2;
    String[] arrayOfString3 = new String[3];
    arrayOfString3[0] = "android.media.metadata.DISPLAY_ICON_URI";
    arrayOfString3[1] = "android.media.metadata.ART_URI";
    arrayOfString3[2] = "android.media.metadata.ALBUM_ART_URI";
    PREFERRED_URI_ORDER = arrayOfString3;
  }
  ...
  public MediaDescriptionCompat getDescription()
  {
    ...
    for (int i1 = 0;; i1++) {
      if (i1 < PREFERRED_URI_ORDER.length)
      {
      ...
      else
      {
        ...
        localBuilder.setIconBitmap((Bitmap)localObject);
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/MediaMetadataCompat.class
