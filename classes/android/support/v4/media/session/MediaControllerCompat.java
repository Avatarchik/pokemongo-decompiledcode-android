...
public final class MediaControllerCompat
{
    ...
    throws RemoteException
  {
    ...
    for (this.mImpl = new MediaControllerImplApi21(paramContext, paramToken);; this.mImpl = new MediaControllerImplBase(this.mToken)) {
      return;
    }
  }
    ...
    extends MediaControllerCompat.MediaControllerImplApi21
  {
    ...
    public MediaControllerCompat.TransportControls getTransportControls()
    {
      ...
      if (localObject != null) {}
      for (MediaControllerCompat.TransportControlsApi23 localTransportControlsApi23 = new MediaControllerCompat.TransportControlsApi23(localObject);; localTransportControlsApi23 = null) {
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public Bundle getExtras()
    {
      try
      {
        Bundle localBundle2 = this.mBinder.getExtras();
    ...
    public MediaMetadataCompat getMetadata()
    {
      try
      {
        MediaMetadataCompat localMediaMetadataCompat2 = this.mBinder.getMetadata();
        localMediaMetadataCompat1 = localMediaMetadataCompat2;
      }
      catch (RemoteException localRemoteException)
      {
        for (;;)
        {
          ...
          MediaMetadataCompat localMediaMetadataCompat1 = null;
        }
      }
      return localMediaMetadataCompat1;
    }
    ...
    public String getPackageName()
    {
      try
      {
        String str2 = this.mBinder.getPackageName();
        str1 = str2;
      }
      catch (RemoteException localRemoteException)
      {
    ...
    public MediaControllerCompat.PlaybackInfo getPlaybackInfo()
    {
      try
      {
        ...
        localPlaybackInfo = new MediaControllerCompat.PlaybackInfo(localParcelableVolumeInfo.volumeType, localParcelableVolumeInfo.audioStream, localParcelableVolumeInfo.controlType, localParcelableVolumeInfo.maxVolume, localParcelableVolumeInfo.currentVolume);
        return localPlaybackInfo;
      }
      catch (RemoteException localRemoteException)
      {
    ...
    public PlaybackStateCompat getPlaybackState()
    {
      try
      {
        PlaybackStateCompat localPlaybackStateCompat2 = this.mBinder.getPlaybackState();
        localPlaybackStateCompat1 = localPlaybackStateCompat2;
      }
      catch (RemoteException localRemoteException)
      {
        for (;;)
        {
          ...
          PlaybackStateCompat localPlaybackStateCompat1 = null;
        }
      }
    ...
    public List<MediaSessionCompat.QueueItem> getQueue()
    {
      try
      {
        List localList2 = this.mBinder.getQueue();
    ...
    public CharSequence getQueueTitle()
    {
      try
      {
        CharSequence localCharSequence2 = this.mBinder.getQueueTitle();
    ...
    public int getRatingType()
    {
      try
      {
        int j = this.mBinder.getRatingType();
        i = j;
      }
      catch (RemoteException localRemoteException)
      {
    ...
    public PendingIntent getSessionActivity()
    {
      try
      {
        PendingIntent localPendingIntent2 = this.mBinder.getLaunchPendingIntent();
    ...
    implements IBinder.DeathRecipient
  {
    ...
    {
      if (Build.VERSION.SDK_INT >= 21) {}
      for (this.mCallbackObj = MediaControllerCompatApi21.createCallback(new StubApi21(null));; this.mCallbackObj = new StubCompat(null)) {
        return;
      }
    }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/session/MediaControllerCompat.class
