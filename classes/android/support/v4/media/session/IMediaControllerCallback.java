  ...
  extends IInterface
{
    ...
    implements IMediaControllerCallback
  {
    ...
    public static IMediaControllerCallback asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        return (IMediaControllerCallback)localObject;
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMediaControllerCallback))) {
          localObject = (IMediaControllerCallback)localIInterface;
        } else {
      ...
      implements IMediaControllerCallback
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	android/support/v4/media/session/IMediaControllerCallback$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_3
        //   36: aconst_null
        //   37: iconst_1
        ...
        throws RemoteException
      {
        ...
        //   25: aload_0
        //   26: getfield 18	android/support/v4/media/session/IMediaControllerCallback$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   29: bipush 7
        //   31: aload_2
        //   32: aconst_null
        //   33: iconst_1
        ...
        throws RemoteException
      {
        ...
        //   20: aload_2
        //   21: iconst_0
        //   22: invokestatic 84	android/text/TextUtils:writeToParcel	(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V
        //   25: aload_0
        //   26: getfield 18	android/support/v4/media/session/IMediaControllerCallback$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   29: bipush 6
        //   31: aload_2
        ...
        throws RemoteException
      {
        ...
        //   20: aload_2
        //   21: iconst_0
        //   22: invokevirtual 90	android/support/v4/media/session/ParcelableVolumeInfo:writeToParcel	(Landroid/os/Parcel;I)V
        //   25: aload_0
        //   26: getfield 18	android/support/v4/media/session/IMediaControllerCallback$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   29: bipush 8
        //   31: aload_2
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/session/IMediaControllerCallback.class
