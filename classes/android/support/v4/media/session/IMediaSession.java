  ...
  extends IInterface
{
    ...
    implements IMediaSession
  {
    ...
    public static IMediaSession asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        return (IMediaSession)localObject;
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMediaSession))) {
          localObject = (IMediaSession)localIInterface;
        } else {
      ...
      throws RemoteException
    {
      ...
      for (;;)
      {
        ...
        if (localPendingIntent != null)
        {
          ...
          localPendingIntent.writeToParcel(paramParcel2, j);
        }
        else
        {
          ...
          {
            paramParcel2.writeInt(j);
            localParcelableVolumeInfo.writeToParcel(paramParcel2, j);
          }
          else
          {
            paramParcel2.writeInt(0);
            ...
            {
              paramParcel2.writeInt(j);
              localMediaMetadataCompat.writeToParcel(paramParcel2, j);
            }
            else
            {
              paramParcel2.writeInt(0);
              ...
              {
                paramParcel2.writeInt(j);
                localPlaybackStateCompat.writeToParcel(paramParcel2, j);
              }
              else
              {
                paramParcel2.writeInt(0);
                ...
                {
                  paramParcel2.writeInt(j);
                  TextUtils.writeToParcel(localCharSequence, paramParcel2, j);
                }
                else
                {
                  paramParcel2.writeInt(0);
      ...
      implements IMediaSession
    {
        ...
        throws RemoteException
      {
        ...
        //   14: aload_0
        //   15: getfield 18	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   18: bipush 31
        //   20: aload_1
        //   21: aload_2
        //   22: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 62	android/os/Parcel:readInt	()I
        //   37: ifeq +28 -> 65
        //   40: getstatic 116	android/text/TextUtils:CHAR_SEQUENCE_CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_2
        //   44: invokeinterface 74 2 0
        //   49: checkcast 118	java/lang/CharSequence
        //   52: astore 5
        //   54: aload_2
        //   55: invokevirtual 53	android/os/Parcel:recycle	()V
        //   58: aload_1
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 62	android/os/Parcel:readInt	()I
        //   37: ifeq +28 -> 65
        //   40: getstatic 125	android/support/v4/media/session/ParcelableVolumeInfo:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_2
        //   44: invokeinterface 74 2 0
        //   49: checkcast 124	android/support/v4/media/session/ParcelableVolumeInfo
        //   52: astore 5
        //   54: aload_2
        //   55: invokevirtual 53	android/os/Parcel:recycle	()V
        //   58: aload_1
        ...
        throws RemoteException
      {
        ...
        //   30: aload_3
        //   31: iconst_0
        //   32: invokevirtual 136	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   35: aload_0
        //   36: getfield 18	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   39: bipush 14
        //   41: aload_3
        //   42: aload 4
        //   44: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 148	android/support/v4/media/RatingCompat:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 18	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   33: bipush 25
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   15: ifnull +44 -> 59
        //   18: aload_1
        //   19: invokeinterface 154 1 0
        //   24: astore 5
        //   26: aload_2
        //   27: aload 5
        //   29: invokevirtual 157	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   32: aload_0
        //   33: getfield 18	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   36: iconst_3
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/session/IMediaSession.class
