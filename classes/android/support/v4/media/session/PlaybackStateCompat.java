    ...
    implements Parcelable
  {
    ...
    public static CustomAction fromCustomAction(Object paramObject)
    {
      ...
      for (;;)
      {
        ...
        localCustomAction = new CustomAction(PlaybackStateCompatApi21.CustomAction.getAction(paramObject), PlaybackStateCompatApi21.CustomAction.getName(paramObject), PlaybackStateCompatApi21.CustomAction.getIcon(paramObject), PlaybackStateCompatApi21.CustomAction.getExtras(paramObject));
    ...
    public Object getCustomAction()
    {
      ...
      for (Object localObject = this.mCustomActionObj;; localObject = this.mCustomActionObj)
      {
        return localObject;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/android/support/v4/media/session/PlaybackStateCompat.class
