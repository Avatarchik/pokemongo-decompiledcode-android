    ...
    implements Subscription
  {
      ...
      extends Subscriber<T2>
    {
      ...
      public void onNext(T2 paramT2)
      {
        ...
        //   184: aload_0
        //   185: aload_2
        //   186: invokevirtual 136	rx/internal/operators/OnSubscribeGroupJoin$ResultManager$RightObserver:onError	(Ljava/lang/Throwable;)V
        //   189: return
        //   190: astore 4
        //   192: aload_3
        //   193: monitorexit
        ...
        //   0	205	0	this	RightObserver
        //   0	205	1	paramT2	T2
        //   183	3	2	localThrowable	Throwable
        //   190	5	4	localObject2	Object
        //   14	10	5	localResultManager	OnSubscribeGroupJoin.ResultManager
        //   21	62	6	i	int
        //   72	30	8	localObservable	Observable
        //   87	17	9	localRightDurationObserver	OnSubscribeGroupJoin.ResultManager.RightDurationObserver
        //   140	6	12	localArrayList	ArrayList
        //   197	6	13	localObject4	Object
        //   152	13	14	localIterator	Iterator
        // Exception table:
        //   from	to	target	type
      ...
      extends Subscriber<T1>
    {
      ...
      public void onNext(T1 paramT1)
      {
        ...
        //   252: aload_0
        //   253: aload_2
        //   254: invokevirtual 172	rx/internal/operators/OnSubscribeGroupJoin$ResultManager$LeftObserver:onError	(Ljava/lang/Throwable;)V
        //   257: return
        //   258: astore 6
        //   260: aload 5
        //   262: monitorexit
        ...
        // Local variable table:
        //   start	length	slot	name	signature
        //   0	274	0	this	LeftObserver
        //   0	274	1	paramT1	T1
        //   251	3	2	localThrowable	Throwable
        //   3	73	3	localPublishSubject	rx.subjects.PublishSubject
        //   12	223	4	localSerializedObserver	rx.observers.SerializedObserver
        //   258	6	6	localObject2	Object
        //   30	10	7	localResultManager	OnSubscribeGroupJoin.ResultManager
        //   37	84	8	i	int
        //   89	70	10	localObservable1	Observable
        //   110	30	11	localObservable2	Observable
        //   125	17	12	localLeftDurationObserver	OnSubscribeGroupJoin.ResultManager.LeftDurationObserver
        //   165	46	14	localObject3	Object
        //   198	18	16	localArrayList	ArrayList
        //   266	6	17	localObject5	Object
        //   222	15	18	localIterator	Iterator
        // Exception table:
        //   from	to	target	type
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/rx/internal/operators/OnSubscribeGroupJoin.class
