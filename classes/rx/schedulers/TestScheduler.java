  ...
  extends Scheduler
{
    ...
    implements Comparator<TestScheduler.TimedAction>
  {
    public int compare(TestScheduler.TimedAction paramTimedAction1, TestScheduler.TimedAction paramTimedAction2)
    {
      ...
      for (int i = Long.valueOf(TestScheduler.TimedAction.access$300(paramTimedAction1)).compareTo(Long.valueOf(TestScheduler.TimedAction.access$300(paramTimedAction2)));; i = Long.valueOf(TestScheduler.TimedAction.access$200(paramTimedAction1)).compareTo(Long.valueOf(TestScheduler.TimedAction.access$200(paramTimedAction2)))) {
        return i;
      }
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/rx/schedulers/TestScheduler.class
