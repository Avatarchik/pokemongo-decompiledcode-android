...
public final class Actions
{
  ...
  public static <T1, R> Func1<T1, R> toFunc(Action1<T1> paramAction1, final R paramR)
  {
    new Func1()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, R> Func2<T1, T2, R> toFunc(Action2<T1, T2> paramAction2, final R paramR)
  {
    new Func2()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, R> Func3<T1, T2, T3, R> toFunc(Action3<T1, T2, T3> paramAction3, final R paramR)
  {
    new Func3()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, T4, R> Func4<T1, T2, T3, T4, R> toFunc(Action4<T1, T2, T3, T4> paramAction4, final R paramR)
  {
    new Func4()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3, paramAnonymousT4);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, T4, T5, R> Func5<T1, T2, T3, T4, T5, R> toFunc(Action5<T1, T2, T3, T4, T5> paramAction5, final R paramR)
  {
    new Func5()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3, paramAnonymousT4, paramAnonymousT5);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, T4, T5, T6, R> Func6<T1, T2, T3, T4, T5, T6, R> toFunc(Action6<T1, T2, T3, T4, T5, T6> paramAction6, final R paramR)
  {
    new Func6()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3, paramAnonymousT4, paramAnonymousT5, paramAnonymousT6);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, R> Func7<T1, T2, T3, T4, T5, T6, T7, R> toFunc(Action7<T1, T2, T3, T4, T5, T6, T7> paramAction7, final R paramR)
  {
    new Func7()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3, paramAnonymousT4, paramAnonymousT5, paramAnonymousT6, paramAnonymousT7);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Func8<T1, T2, T3, T4, T5, T6, T7, T8, R> toFunc(Action8<T1, T2, T3, T4, T5, T6, T7, T8> paramAction8, final R paramR)
  {
    new Func8()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3, paramAnonymousT4, paramAnonymousT5, paramAnonymousT6, paramAnonymousT7, paramAnonymousT8);
        return (R)paramR;
      }
    };
  }
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> toFunc(Action9<T1, T2, T3, T4, T5, T6, T7, T8, T9> paramAction9, final R paramR)
  {
    new Func9()
    {
      ...
      {
        Actions.this.call(paramAnonymousT1, paramAnonymousT2, paramAnonymousT3, paramAnonymousT4, paramAnonymousT5, paramAnonymousT6, paramAnonymousT7, paramAnonymousT8, paramAnonymousT9);
        return (R)paramR;
      }
    };
  }
  ...
  public static <R> FuncN<R> toFunc(ActionN paramActionN, final R paramR)
  {
    new FuncN()
    {
      ...
      {
        Actions.this.call(paramAnonymousVarArgs);
        return (R)paramR;
      }
    };
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/rx/functions/Actions.class
