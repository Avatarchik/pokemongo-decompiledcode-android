...
public class FileFilterUtils
{
  ...
  public static File[] filter(IOFileFilter paramIOFileFilter, File... paramVarArgs)
  {
    ...
    for (File[] arrayOfFile = new File[0];; arrayOfFile = (File[])localArrayList.toArray(new File[localArrayList.size()]))
    {
      return arrayOfFile;
  ...
  public static IOFileFilter makeCVSAware(IOFileFilter paramIOFileFilter)
  {
    ...
    for (IOFileFilter localIOFileFilter = cvsFilter;; localIOFileFilter = and(arrayOfIOFileFilter))
    {
  ...
  {
    if (paramIOFileFilter == null) {}
    for (Object localObject = DirectoryFileFilter.DIRECTORY;; localObject = new AndFileFilter(DirectoryFileFilter.DIRECTORY, paramIOFileFilter)) {
      return (IOFileFilter)localObject;
    }
  }
  ...
  {
    if (paramIOFileFilter == null) {}
    for (Object localObject = FileFileFilter.FILE;; localObject = new AndFileFilter(FileFileFilter.FILE, paramIOFileFilter)) {
      return (IOFileFilter)localObject;
    }
  }
  ...
  public static IOFileFilter makeSVNAware(IOFileFilter paramIOFileFilter)
  {
    if (paramIOFileFilter == null) {}
    IOFileFilter[] arrayOfIOFileFilter;
    for (IOFileFilter localIOFileFilter = svnFilter;; localIOFileFilter = and(arrayOfIOFileFilter))
    {
      return localIOFileFilter;
      arrayOfIOFileFilter = new IOFileFilter[2];
      arrayOfIOFileFilter[0] = paramIOFileFilter;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/org/apache/commons/io/filefilter/FileFilterUtils.class
