...
public class FileSystemUtils
{
    ...
    throws IOException
  {
    int i = 0;
    int j = 0;
    int k = -1 + paramString1.length();
    if (k >= 0)
    {
      if (!Character.isDigit(paramString1.charAt(k))) {
        break label115;
      }
      j = k + 1;
    }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/org/apache/commons/io/FileSystemUtils.class
