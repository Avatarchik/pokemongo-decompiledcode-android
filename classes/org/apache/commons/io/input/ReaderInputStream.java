  ...
  extends InputStream
{
    ...
    throws IOException
  {
    ...
    for (int i = 0xFF & this.encoderOut.get();; i = -1)
    {
      return i;
      fillBuffer();
    ...
    for (;;)
    {
      ...
      do
      {
        for (;;)
        {
          ...
          int k = Math.min(this.encoderOut.remaining(), paramInt2);
          this.encoderOut.get(paramArrayOfByte, paramInt1, k);
          paramInt1 += k;
          paramInt2 -= k;
          i += k;
        }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/org/apache/commons/io/input/ReaderInputStream.class
