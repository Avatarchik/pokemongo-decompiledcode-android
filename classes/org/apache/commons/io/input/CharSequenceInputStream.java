  ...
  extends InputStream
{
    ...
    throws IOException
  {
    ...
    for (int i = 0xFF & this.bbuf.get();; i = -1)
    {
      return i;
      fillBuffer();
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/org/apache/commons/io/input/CharSequenceInputStream.class
