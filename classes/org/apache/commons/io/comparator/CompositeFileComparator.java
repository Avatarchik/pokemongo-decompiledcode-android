  ...
  implements Serializable
{
  ...
  public CompositeFileComparator(Iterable<Comparator<File>> paramIterable)
  {
    ...
    for (this.delegates = ((Comparator[])NO_COMPARATORS);; this.delegates = ((Comparator[])localArrayList.toArray(new Comparator[localArrayList.size()])))
    {
      return;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/org/apache/commons/io/comparator/CompositeFileComparator.class
