...
public class IOUtils
{
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      break;
      if (localBufferedReader2.read() == -1) {
        bool = true;
      }
    }
  }
  ...
  public static BufferedReader toBufferedReader(Reader paramReader)
  {
    ...
    for (BufferedReader localBufferedReader = (BufferedReader)paramReader;; localBufferedReader = new BufferedReader(paramReader)) {
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/org/apache/commons/io/IOUtils.class
