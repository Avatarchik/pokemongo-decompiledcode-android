  ...
  implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, SurfaceHolder.Callback, MediaController.MediaPlayerControl
{
  ...
  private void a()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        try
        {
          AssetFileDescriptor localAssetFileDescriptor = localAssetManager.openFd(this.f);
          this.r.setDataSource(localAssetFileDescriptor.getFileDescriptor(), localAssetFileDescriptor.getStartOffset(), localAssetFileDescriptor.getLength());
  ...
  protected final void updateVideoLayout()
  {
    ...
    if ((this.n == 0) || (this.o == 0))
    {
      ...
      this.o = localWindowManager.getDefaultDisplay().getHeight();
    }
    int i1 = this.n;
    int i2 = this.o;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/unity3d/player/w.class
