  ...
  extends ContextService
{
  ...
  private int[] statusArray()
  {
    ...
    arrayOfInt[0] = ((ServiceStatus)this.statusMap.get("gps")).ordinal();
    arrayOfInt[1] = ((ServiceStatus)this.statusMap.get("network")).ordinal();
    arrayOfInt[2] = ((ServiceStatus)this.statusMap.get("fused")).ordinal();
    return arrayOfInt;
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/nianticlabs/nia/location/NianticLocationManager.class
