  ...
  extends TypeAdapter<Date>
{
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory()
  {
    public <T> TypeAdapter<T> create(Gson paramAnonymousGson, TypeToken<T> paramAnonymousTypeToken)
    {
      ...
      for (SqlDateTypeAdapter localSqlDateTypeAdapter = new SqlDateTypeAdapter();; localSqlDateTypeAdapter = null) {
        return localSqlDateTypeAdapter;
      }
    }
  };
    ...
    throws IOException
  {
    ...
    //   40: invokespecial 73	java/sql/Date:<init>	(J)V
    //   43: astore_3
    //   44: goto -26 -> 18
    //   47: astore 4
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/gson/internal/bind/SqlDateTypeAdapter.class
