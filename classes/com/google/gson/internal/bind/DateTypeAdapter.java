  ...
  extends TypeAdapter<Date>
{
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory()
  {
    public <T> TypeAdapter<T> create(Gson paramAnonymousGson, TypeToken<T> paramAnonymousTypeToken)
    {
      ...
      for (DateTypeAdapter localDateTypeAdapter = new DateTypeAdapter();; localDateTypeAdapter = null) {
    ...
    throws IOException
  {
    ...
    for (Date localDate = null;; localDate = deserializeToDate(paramJsonReader.nextString())) {
      return localDate;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/gson/internal/bind/DateTypeAdapter.class
