    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      else if ((localObject instanceof JsonPrimitive))
      {
        ...
        } else if (localJsonPrimitive.isNumber()) {
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/gson/internal/bind/JsonTreeReader.class
