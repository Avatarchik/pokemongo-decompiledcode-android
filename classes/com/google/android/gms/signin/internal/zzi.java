  ...
  implements zzqw
{
  ...
  public zzi(Context paramContext, Looper paramLooper, boolean paramBoolean, com.google.android.gms.common.internal.zzf paramzzf, zzqx paramzzqx, GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener, ExecutorService paramExecutorService)
  {
    ...
    this.zzafj = paramzzf.zzoR();
    this.zzaVm = paramExecutorService;
  }
  ...
  public void zza(zzp paramzzp, boolean paramBoolean)
  {
    try
    {
      ((zzf)zzpc()).zza(paramzzp, this.zzafj.intValue(), paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void zza(zzt paramzzt)
  {
    ...
    try
    {
      Account localAccount = this.zzabI.zzoI();
      ((zzf)zzpc()).zza(new ResolveAccountRequest(localAccount, this.zzafj.intValue()), paramzzt);
      return;
    }
    catch (RemoteException localRemoteException1)
    {
  ...
  {
    Bundle localBundle = zza(this.zzaaT, this.zzabI.zzoR(), this.zzaVm);
    String str = this.zzabI.zzoN();
    if (!getContext().getPackageName().equals(str)) {
      localBundle.putString("com.google.android.gms.signin.internal.realClientPackageName", this.zzabI.zzoN());
    }
    return localBundle;
  }
      ...
      this.zzaVm.submit(new Runnable()
      {
        public void run()
        {
          try
          {
            ...
            CheckServerAuthResult localCheckServerAuthResult = new CheckServerAuthResult(localCheckResult.zznD(), localCheckResult.zznE());
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/signin/internal/zzi.class
