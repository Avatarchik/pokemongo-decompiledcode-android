  ...
  static
  {
    zzRl = new Api.zza()
    {
      public zzi zza(Context paramAnonymousContext, Looper paramAnonymousLooper, zzf paramAnonymouszzf, zzqx paramAnonymouszzqx, GoogleApiClient.ConnectionCallbacks paramAnonymousConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener paramAnonymousOnConnectionFailedListener)
      {
        ...
        for (zzqx localzzqx = zzqx.zzaUZ;; localzzqx = paramAnonymouszzqx) {
          return new zzi(paramAnonymousContext, paramAnonymousLooper, true, paramAnonymouszzf, localzzqx, paramAnonymousConnectionCallbacks, paramAnonymousOnConnectionFailedListener, Executors.newSingleThreadExecutor());
        }
      }
    };
    zzaUX = new Api.zza()
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/internal/zzqu.class
