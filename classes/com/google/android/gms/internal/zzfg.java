  ...
  implements zzdk
{
  ...
  void zzej()
  {
    ...
    Activity localActivity = this.zzoM.zzgZ();
    if ((localActivity == null) || (localActivity.getWindow() == null)) {
      this.zzAG = this.zzAD;
    }
    int[] arrayOfInt;
    for (this.zzAH = this.zzAE;; this.zzAH = zzl.zzcF().zzb(this.zzAB, arrayOfInt[1]))
    {
      return;
      arrayOfInt = zzp.zzbv().zzg(localActivity);
      this.zzAG = zzl.zzcF().zzb(this.zzAB, arrayOfInt[0]);
    }
  }
  ...
  void zzek()
  {
    ...
    for (this.zzAJ = this.zzAE;; this.zzAJ = zzl.zzcF().zzc(this.mContext, this.zzoM.getMeasuredHeight()))
    {
      return;
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/internal/zzfg.class
