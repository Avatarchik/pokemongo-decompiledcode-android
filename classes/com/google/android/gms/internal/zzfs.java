  ...
  extends IInterface
{
    ...
    implements zzfs
  {
    ...
    public static zzfs zzP(IBinder paramIBinder)
    {
      Object localObject;
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof zzfs))) {
          localObject = (zzfs)localIInterface;
        } else {
      ...
      throws RemoteException
    {
      ...
      for (;;)
      {
        ...
        zza(zzfr.zza.zzO(paramParcel1.readStrongBinder()));
      ...
      implements zzfs
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 18	com/google/android/gms/internal/zzfs$zza$zza:zznJ	Landroid/os/IBinder;
        //   36: iconst_1
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/internal/zzfs.class
