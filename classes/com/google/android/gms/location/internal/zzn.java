  ...
  implements Parcelable.Creator<LocationRequestUpdateData>
{
  static void zza(LocationRequestUpdateData paramLocationRequestUpdateData, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramLocationRequestUpdateData.zzaFJ);
    zzb.zzc(paramParcel, 1000, paramLocationRequestUpdateData.getVersionCode());
    zzb.zza(paramParcel, 2, paramLocationRequestUpdateData.zzaFK, paramInt, false);
  ...
  public LocationRequestUpdateData zzeI(Parcel paramParcel)
  {
    ...
    return new LocationRequestUpdateData(j, k, localLocationRequestInternal, localIBinder3, localPendingIntent, localIBinder2, localIBinder1);
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/location/internal/zzn.class
