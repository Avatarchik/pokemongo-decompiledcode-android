  ...
  implements Parcelable.Creator<AutocompletePredictionEntity>
{
  static void zza(AutocompletePredictionEntity paramAutocompletePredictionEntity, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 1, paramAutocompletePredictionEntity.zzaGO, false);
    zzb.zzc(paramParcel, 1000, paramAutocompletePredictionEntity.mVersionCode);
    zzb.zza(paramParcel, 2, paramAutocompletePredictionEntity.zzaGt, false);
    zzb.zza(paramParcel, 3, paramAutocompletePredictionEntity.zzaFT, false);
    zzb.zzc(paramParcel, 4, paramAutocompletePredictionEntity.zzaGP, false);
    zzb.zzc(paramParcel, 5, paramAutocompletePredictionEntity.zzaGQ);
    zzb.zza(paramParcel, 6, paramAutocompletePredictionEntity.zzaGR, false);
    zzb.zzc(paramParcel, 7, paramAutocompletePredictionEntity.zzaGS, false);
    zzb.zza(paramParcel, 8, paramAutocompletePredictionEntity.zzaGT, false);
    zzb.zzc(paramParcel, 9, paramAutocompletePredictionEntity.zzaGU, false);
  ...
  public AutocompletePredictionEntity zzeU(Parcel paramParcel)
  {
    ...
    return new AutocompletePredictionEntity(k, str4, localArrayList4, i, str3, localArrayList3, str2, localArrayList2, str1, localArrayList1);
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/location/places/internal/zza.class
