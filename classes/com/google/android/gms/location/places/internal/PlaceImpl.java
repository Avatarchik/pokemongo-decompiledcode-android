  ...
  implements SafeParcelable, Place
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        PlaceImpl localPlaceImpl = (PlaceImpl)paramObject;
        if ((!this.zzwN.equals(localPlaceImpl.zzwN)) || (!zzw.equal(this.zzaHc, localPlaceImpl.zzaHc)) || (this.zzaHq != localPlaceImpl.zzaHq)) {
          bool = false;
        }
      }
    }
  ...
  public int hashCode()
  {
    ...
    arrayOfObject[1] = this.zzaHc;
    arrayOfObject[2] = Long.valueOf(this.zzaHq);
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/location/places/internal/PlaceImpl.class
