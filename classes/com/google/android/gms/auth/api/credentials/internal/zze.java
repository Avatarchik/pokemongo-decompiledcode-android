  ...
  extends zzj<zzh>
{
  ...
  {
    if (this.zzSJ == null) {}
    for (Bundle localBundle = new Bundle();; localBundle = this.zzSJ.zzly()) {
      return localBundle;
    }
  }
}
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/auth/api/credentials/internal/zze.class
