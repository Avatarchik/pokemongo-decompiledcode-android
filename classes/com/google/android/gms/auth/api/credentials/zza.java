  ...
  implements Parcelable.Creator<Credential>
{
  static void zza(Credential paramCredential, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 8, paramCredential.zzlI(), false);
  ...
  public Credential zzE(Parcel paramParcel)
  {
    ...
    return new Credential(j, str6, str5, localUri, localArrayList, str4, str3, str2, str1);
  }
  
  public Credential[] zzav(int paramInt)
  {
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/auth/api/credentials/zza.class
