  ...
  implements SafeParcelable, FastJsonResponse.zza<String, Integer>
{
  ...
  public String zzb(Integer paramInteger)
  {
    ...
    if ((str == null) && (this.zzagP.containsKey("gms_unknown"))) {
      str = "gms_unknown";
    }
    return str;
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/common/server/converter/StringToIntConverter.class
