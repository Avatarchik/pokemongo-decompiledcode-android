...
public final class AdSize
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((this.zznQ != localAdSize.zznQ) || (this.zznR != localAdSize.zznR) || (!this.zznS.equals(localAdSize.zznS))) {
          bool = false;
        }
      }
    }
  ...
  public int getHeightInPixels(Context paramContext)
  {
    ...
    {
    default: 
      i = zzl.zzcF().zzb(paramContext, this.zznR);
    }
    for (;;)
    {
      return i;
      i = AdSizeParcel.zzb(paramContext.getResources().getDisplayMetrics());
      continue;
      i = -1;
    }
  }
  ...
  public int getWidthInPixels(Context paramContext)
  {
    ...
    case -2: 
    default: 
      i = zzl.zzcF().zzb(paramContext, this.zznQ);
    }
    for (;;)
    {
      return i;
      i = AdSizeParcel.zza(paramContext.getResources().getDisplayMetrics());
      continue;
      i = -1;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/google/android/gms/ads/AdSize.class
