...
public class UiHandler
{
  ...
  public void onFinish(String paramString)
  {
    ...
    {
      String str = (String)this.queueList.remove(-1 + this.queueList.size());
      pushToActivityQueue((Bundle)this.uiElementsMap.get(str), str);
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/voxelbusters/nativeplugins/features/ui/UiHandler.class
