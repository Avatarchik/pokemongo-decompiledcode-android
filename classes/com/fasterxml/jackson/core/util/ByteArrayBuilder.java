  ...
  extends OutputStream
{
  ...
  public ByteArrayBuilder(BufferRecycler paramBufferRecycler, int paramInt)
  {
    ...
    for (byte[] arrayOfByte = new byte[paramInt];; arrayOfByte = paramBufferRecycler.allocByteBuffer(2))
    {
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/fasterxml/jackson/core/util/ByteArrayBuilder.class
