  ...
  implements Serializable
{
  ...
  public PropertyName findRootName(JavaType paramJavaType)
  {
    ...
    for (PropertyName localPropertyName = this._rootName;; localPropertyName = this._rootNames.findRootName(paramJavaType, this)) {
  ...
  {
    if (this._rootName != null) {}
    for (PropertyName localPropertyName = this._rootName;; localPropertyName = this._rootNames.findRootName(paramClass, this)) {
      return localPropertyName;
    }
  }
  ...
  {
    if (this._rootName == null) {}
    for (String str = null;; str = this._rootName.getSimpleName()) {
      return str;
    }
  }
  ...
  {
    if (paramString == null) {}
    for (MapperConfigBase localMapperConfigBase = withRootName((PropertyName)null);; localMapperConfigBase = withRootName(PropertyName.construct(paramString))) {
      return localMapperConfigBase;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/fasterxml/jackson/databind/cfg/MapperConfigBase.class
