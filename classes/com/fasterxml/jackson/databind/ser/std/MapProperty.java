  ...
  extends PropertyWriter
{
  ...
  public <A extends Annotation> A getAnnotation(Class<A> paramClass)
  {
    ...
    for (Object localObject = null;; localObject = this._property.getAnnotation(paramClass)) {
  ...
  {
    if (this._property == null) {}
    for (Object localObject = null;; localObject = this._property.getContextAnnotation(paramClass)) {
      return (A)localObject;
    }
  }
  ...
  public String getName()
  {
    ...
    for (String str = (String)this._key;; str = String.valueOf(this._key)) {
      return str;
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/fasterxml/jackson/databind/ser/std/MapProperty.class
