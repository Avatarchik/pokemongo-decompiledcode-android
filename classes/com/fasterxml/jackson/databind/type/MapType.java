  ...
  extends MapLikeType
{
  ...
  public JavaType narrowContentsBy(Class<?> paramClass)
  {
    ...
    {
      return this;
      this = new MapType(this._class, this._keyType, this._valueType.narrowBy(paramClass), this._valueHandler, this._typeHandler, this._asStatic);
    }
  }
  ...
  public JavaType narrowKey(Class<?> paramClass)
  {
    ...
    {
      return this;
      this = new MapType(this._class, this._keyType.narrowBy(paramClass), this._valueType, this._valueHandler, this._typeHandler, this._asStatic);
    }
  }
  ...
  public JavaType widenContentsBy(Class<?> paramClass)
  {
    ...
    {
      return this;
      this = new MapType(this._class, this._keyType, this._valueType.widenBy(paramClass), this._valueHandler, this._typeHandler, this._asStatic);
    }
  }
  ...
  public JavaType widenKey(Class<?> paramClass)
  {
    ...
    {
      return this;
      this = new MapType(this._class, this._keyType.widenBy(paramClass), this._valueType, this._valueHandler, this._typeHandler, this._asStatic);
    }
  }
  ...
  public MapType withStaticTyping()
  {
    ...
    {
      return this;
      this = new MapType(this._class, this._keyType.withStaticTyping(), this._valueType.withStaticTyping(), this._valueHandler, this._typeHandler, true);
    }
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/fasterxml/jackson/databind/type/MapType.class
