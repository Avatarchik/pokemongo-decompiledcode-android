...
public class ReadableObjectId
{
  ...
  {
    if (this._referringProperties == null) {}
    for (Iterator localIterator = Collections.emptyList().iterator();; localIterator = this._referringProperties.iterator()) {
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/fasterxml/jackson/databind/deser/impl/ReadableObjectId.class
