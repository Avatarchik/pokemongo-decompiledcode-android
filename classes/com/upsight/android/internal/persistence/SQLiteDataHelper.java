  ...
  implements DataHelper
{
  ...
  {
    return this.mOpenHelper.getWritableDatabase().delete("models", paramString, paramArrayOfString);
  }
  
  public long insert(ContentValues paramContentValues)
  {
    return this.mOpenHelper.getWritableDatabase().insert("models", null, paramContentValues);
  }
  
  public Cursor query(String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    return this.mOpenHelper.getReadableDatabase().query("models", paramArrayOfString1, paramString1, paramArrayOfString2, null, null, paramString2);
  }
  
  public int update(ContentValues paramContentValues, String paramString, String[] paramArrayOfString)
  {
    return this.mOpenHelper.getWritableDatabase().update("models", paramContentValues, paramString, paramArrayOfString);
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/upsight/android/internal/persistence/SQLiteDataHelper.class
