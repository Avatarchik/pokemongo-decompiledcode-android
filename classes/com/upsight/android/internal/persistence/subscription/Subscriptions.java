...
public class Subscriptions
{
  ...
  public static <T> Action1<T> publishCreated(Bus paramBus, final String paramString)
  {
    new Action1()
    {
      ...
      {
        Subscriptions.this.post(new DataStoreEvent(DataStoreEvent.Action.Created, paramString, paramAnonymousT));
      }
    };
  }
  ...
  public static <T> Action1<T> publishRemoved(Bus paramBus, final String paramString)
  {
    new Action1()
    {
      public void call(T paramAnonymousT)
      {
        Subscriptions.this.post(new DataStoreEvent(DataStoreEvent.Action.Removed, paramString, paramAnonymousT));
      }
    };
  }
  ...
  public static <T> Action1<T> publishUpdated(Bus paramBus, final String paramString)
  {
    new Action1()
    {
      public void call(T paramAnonymousT)
      {
        Subscriptions.this.post(new DataStoreEvent(DataStoreEvent.Action.Updated, paramString, paramAnonymousT));
      }
    };
  }
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/upsight/android/internal/persistence/subscription/Subscriptions.class
