...
public class UpsightCampaignClickEvent
  extends AnalyticsEvent<UpsightData>
{
  protected UpsightCampaignClickEvent() {}
  
  protected UpsightCampaignClickEvent(String paramString, UpsightData paramUpsightData, UpsightPublisherData paramUpsightPublisherData)
  {
    ...
    extends AnalyticsEvent.Builder<UpsightCampaignClickEvent, UpsightCampaignClickEvent.UpsightData>
  {
    ...
    {
      return new UpsightCampaignClickEvent("upsight.campaign.click", new UpsightCampaignClickEvent.UpsightData(this), this.mPublisherDataBuilder.build());
    }
  ...
  static class UpsightData
  {
    ...
    protected UpsightData(UpsightCampaignClickEvent.Builder paramBuilder)
    {
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/upsight/android/analytics/event/campaign/UpsightCampaignClickEvent.class
