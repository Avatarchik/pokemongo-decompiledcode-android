  ...
  implements Factory<Dispatcher>
{
  ...
  {
    Dispatcher localDispatcher = this.module.provideDispatcher((UpsightContext)this.upsightProvider.get(), (SessionManager)this.sessionManagerProvider.get(), (AnalyticsContext)this.contextProvider.get(), (ConfigParser)this.configParserProvider.get(), (RouterBuilder)this.routerBuilderProvider.get(), (SchemaSelectorBuilder)this.schemaSelectorBuilderProvider.get());
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/upsight/android/analytics/internal/dispatcher/DispatchModule_ProvideDispatcherFactory.class
