...
public final class AnalyticsSchedulersModule
{
  ...
  public Scheduler provideSendingExecutor()
  {
    Schedulers.from(new ThreadPoolExecutor(1, 5, 15L, TimeUnit.MINUTES, new LinkedBlockingQueue(), new ThreadFactory()
    {
      ...
      {
        return new Thread(paramAnonymousRunnable, "DispatcherSenderThread-" + this.mSerial.incrementAndGet());
      }
    }));
  }
}
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/com/upsight/android/analytics/internal/AnalyticsSchedulersModule.class
