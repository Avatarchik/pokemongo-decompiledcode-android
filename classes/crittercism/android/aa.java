  ...
  implements ae
{
  ...
  {
    Object localObject = this.a.getInputStream();
    if (localObject != null) {
      try
      {
        if ((this.f != null) && (this.f.a((InputStream)localObject)))
        {
          localObject = this.f;
        }
        else
        {
          this.f = new x(this, (InputStream)localObject, this.b);
          localObject = this.f;
        }
      }
      catch (ThreadDeath localThreadDeath)
  ...
  public final OutputStream getOutputStream()
  {
    ...
    if (localObject != null) {
      try
      {
        if ((this.e != null) && (this.e.a((OutputStream)localObject)))
        {
          localObject = this.e;
        }
        else
        {
          this.e = new w(this, (OutputStream)localObject);
          localObject = this.e;
        }
      }
      catch (ThreadDeath localThreadDeath)
...
/* Location:              /Users/tjledwith/Downloads/dex2jar-0.0.9.8/classes_dex2jar.jar!/crittercism/android/aa.class
